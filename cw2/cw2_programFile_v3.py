...
#print(averageMarksByStudentNumber(studentNum, tableName=marksss))

#2.2
#moduleNum=int(input("Enter a number representing the module you want the average mark for: "))
#print(averageMarksByModuleNumber(moduleNum, tableName=marksss))

#2.3
if(programNumber==1):
    studentName=input("Enter a name representing the student you want the average mark for: ")
    if studentName in students:
        studentNum = students.index(studentName)
        print(averageMarksByStudentNumber(studentNum, tableName=marks))
    else:
        print("There is no such a student")
        
#2.4
elif(programNumber==2):
    moduleName=input("Enter a name representing the module you want the average mark for: ")
    if moduleName in modules:
        moduleNum = modules.index(moduleName)
        print(averageMarksByModuleNumber(moduleNum, tableName=marks))
    else:
